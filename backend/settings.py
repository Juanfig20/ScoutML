...
SECRET_KEY = 'django-insecure-cvk=vh%4vqwq5+6kyxag%p)!_m0y5g%0i02$gx_s850@xr-3)4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False     # Cambiar a False en producción

ALLOWED_HOSTS = ['https://scout-ml-jfdm.vercel.app/']
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'backend.predictions.apps.PredictionsConfig',
